...
namespace lv_Common
{
    ...
    public static class DataToExcel
    {
        ...
        private static int titleColorindex = 15;
        /// <summary>
        /// 标题背景色
        /// </summary>
        public static int TitleColorIndex
        {
            set { titleColorindex = value; }
            get { return titleColorindex; }
        }

        private static DateTime beforeTime;			//Excel启动之前时间
        private static DateTime afterTime;				//Excel启动之后时间
        ...
        /// <returns></returns>
        public static string OutputExcel(System.Data.DataTable dt, string strTitle, string FilePath)
        {

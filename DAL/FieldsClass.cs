...
namespace lv_B2C.DAL  
{
	...
	{
		#region  Method
        private const string _defaultOrder = "FieldsClassID desc ";
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("FieldsClassID", "FieldsClass");
        }
		...
		{
			return Merger(model, "FieldsClass_ADD");	
		}		
		...
		{
			 return Merger(model, "FieldsClass_Update");
		}
		
		/// <summary>
        /// 执行更新或新增的存储过程
        /// </summary>
		private int Merger(lv_B2C.Model.FieldsClass model, string strStoredProcedure)
        {
        	try
            {
        ...
        public int Update(int FieldsClassID, object fieldName, object fieldValue)
        {
            ...
            {
                SqlParameter[] parameters = {
                    new SqlParameter("@FieldsClassID", FieldsClassID),                       
					new SqlParameter("@FieldName", fieldName),
					new SqlParameter("@FieldValue",fieldValue)
                };
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "FieldsClass_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int FieldsClassID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "FieldsClass_Delete", new SqlParameter("@FieldsClassID", FieldsClassID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string FieldsClassIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "FieldsClass_DeleteIDList", new SqlParameter("@FieldsClassIDList", FieldsClassIDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.FieldsClass GetModel(int FieldsClassID)
        {
	        try
	        {
	            IList<lv_B2C.Model.FieldsClass> iListFieldsClass = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.FieldsClass>(CommandType.StoredProcedure, "FieldsClass_GetModel", new SqlParameter("@FieldsClassID", FieldsClassID));
	            if (iListFieldsClass.Count > 0)
	            {
	                return iListFieldsClass[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "FieldsClass_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.FieldsClass> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.FieldsClass>(CommandType.StoredProcedure, "FieldsClass_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.FieldsClass> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.FieldsClass>(CommandType.StoredProcedure, "FieldsClass_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.FieldsClass> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.FieldsClass>(CommandType.StoredProcedure, "FieldsClass_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.FieldsClass> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.FieldsClass>(CommandType.StoredProcedure, "FieldsClass_GetListByPage", parameters);
            }
            catch
            {
                return null;

...
namespace lv_B2C.DAL  
{
	...
	{
		#region  Method
        private const string _defaultOrder = "ADPageID desc ";
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ADPageID", "AdPage");
        }
        ...
        public int Update(int ADPageID, object fieldName, object fieldValue)
        {
            ...
            {
                SqlParameter[] parameters = {
                    new SqlParameter("@ADPageID", ADPageID),                       
					new SqlParameter("@FieldName", fieldName),
					new SqlParameter("@FieldValue",fieldValue)
                };
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "AdPage_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int ADPageID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "AdPage_Delete", new SqlParameter("@ADPageID", ADPageID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string ADPageIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "AdPage_DeleteIDList", new SqlParameter("@ADPageIDList", ADPageIDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.AdPage GetModel(int ADPageID)
        {
	        try
	        {
	            IList<lv_B2C.Model.AdPage> iListAdPage = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.AdPage>(CommandType.StoredProcedure, "AdPage_GetModel", new SqlParameter("@ADPageID", ADPageID));
	            if (iListAdPage.Count > 0)
	            {
	                return iListAdPage[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "AdPage_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.AdPage> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.AdPage>(CommandType.StoredProcedure, "AdPage_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.AdPage> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.AdPage>(CommandType.StoredProcedure, "AdPage_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.AdPage> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.AdPage>(CommandType.StoredProcedure, "AdPage_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.AdPage> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.AdPage>(CommandType.StoredProcedure, "AdPage_GetListByPage", parameters);
            }
            catch
            {
                return null;

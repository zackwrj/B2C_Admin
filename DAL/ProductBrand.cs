...
namespace lv_B2C.DAL  
{
	...
	{
		#region  Method
        private const string _defaultOrder = "ProductBrandID desc ";
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ProductBrandID", "ProductBrand");
        }
        ...
        public int Update(int ProductBrandID, object fieldName, object fieldValue)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "ProductBrand_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int ProductBrandID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "ProductBrand_Delete", new SqlParameter("@ProductBrandID", ProductBrandID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string ProductBrandIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "ProductBrand_DeleteIDList", new SqlParameter("@ProductBrandIDList", ProductBrandIDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.ProductBrand GetModel(int ProductBrandID)
        {
	        try
	        {
	            IList<lv_B2C.Model.ProductBrand> iListProductBrand = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.ProductBrand>(CommandType.StoredProcedure, "ProductBrand_GetModel", new SqlParameter("@ProductBrandID", ProductBrandID));
	            if (iListProductBrand.Count > 0)
	            {
	                return iListProductBrand[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "ProductBrand_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.ProductBrand> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.ProductBrand>(CommandType.StoredProcedure, "ProductBrand_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.ProductBrand> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.ProductBrand>(CommandType.StoredProcedure, "ProductBrand_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.ProductBrand> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.ProductBrand>(CommandType.StoredProcedure, "ProductBrand_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.ProductBrand> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.ProductBrand>(CommandType.StoredProcedure, "ProductBrand_GetListByPage", parameters);
            }
            catch
            {
                return null;

...
namespace lv_B2C.DAL  
{
	...
	{
		#region  Method
        private const string _defaultOrder = "ArticleID desc ";
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ArticleID", "Article");
        }
		...
		{
			return Merger(model, "Article_ADD");	
		}		
		...
		{
			 return Merger(model, "Article_Update");
		}
		
		/// <summary>
        /// 执行更新或新增的存储过程
        /// </summary>
		private int Merger(lv_B2C.Model.Article model, string strStoredProcedure)
        {
        	try
            {
        ...
        public int Update(int ArticleID, object fieldName, object fieldValue)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "Article_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int ArticleID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "Article_Delete", new SqlParameter("@ArticleID", ArticleID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string ArticleIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "Article_DeleteIDList", new SqlParameter("@ArticleIDList", ArticleIDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.Article GetModel(int ArticleID)
        {
	        try
	        {
	            IList<lv_B2C.Model.Article> iListArticle = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.Article>(CommandType.StoredProcedure, "Article_GetModel", new SqlParameter("@ArticleID", ArticleID));
	            if (iListArticle.Count > 0)
	            {
	                return iListArticle[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "Article_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.Article> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.Article>(CommandType.StoredProcedure, "Article_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.Article> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.Article>(CommandType.StoredProcedure, "Article_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.Article> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.Article>(CommandType.StoredProcedure, "Article_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.Article> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.Article>(CommandType.StoredProcedure, "Article_GetListByPage", parameters);
            }
            catch
            {
                return null;

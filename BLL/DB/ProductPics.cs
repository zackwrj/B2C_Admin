...
namespace lv_B2C.BLL {
		...
		public partial class ProductPics
	{
		...
		private readonly lv_B2C.DAL.ProductPics dal=new lv_B2C.DAL.ProductPics();
        ...
        {
            return dal.Update(PicsID, fieldName, fieldValue);
        }
		...
		{
			return dal.DeleteList(PicsIDList );
		}

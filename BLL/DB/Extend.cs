...
namespace lv_B2C.BLL {
		...
		public partial class Extend
	{
		...
		private readonly lv_B2C.DAL.Extend dal=new lv_B2C.DAL.Extend();
        ...
        {
            return dal.Update(ExtendID, fieldName, fieldValue);
        }
		...
		{
			return dal.DeleteList(ExtendIDList );
		}

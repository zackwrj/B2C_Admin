...
namespace lv_B2C.BLL {
		...
		public partial class PriceAnnal
	{
		...
		private readonly lv_B2C.DAL.PriceAnnal dal=new lv_B2C.DAL.PriceAnnal();
		
		protected PriceAnnal()
		{}
		#region  Method
        ...
        {
            return dal.Update(PriceAnnalID, fieldName, fieldValue);
        }
		...
		{
			return dal.Delete(PriceAnnalID);
		}
		...
		{
			return dal.DeleteList(PriceAnnalIDList );
		}
		...
		{			
			return dal.GetModel(PriceAnnalID);
		}

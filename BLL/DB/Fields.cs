...
namespace lv_B2C.BLL
{
    ...
    public partial class Fields
    {
        ...
        private readonly lv_B2C.DAL.Fields dal = new lv_B2C.DAL.Fields();
        ...
        {
            return dal.Update(FieldsID, fieldName, fieldValue);
        }
        ...
        {
            return dal.DeleteList(FieldsIDList);
        }

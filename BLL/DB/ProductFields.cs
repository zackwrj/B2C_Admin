...
namespace lv_B2C.BLL {
		...
		public partial class ProductFields
	{
		...
		private readonly lv_B2C.DAL.ProductFields dal=new lv_B2C.DAL.ProductFields();
        ...
        {
            return dal.Update(ProductFieldsID, fieldName, fieldValue);
        }
		...
		{
			return dal.Delete(ProductFieldsID);
		}
		...
		{
			return dal.DeleteList(ProductFieldsIDList );
		}
		...
		{			
			return dal.GetModel(ProductFieldsID);
		}

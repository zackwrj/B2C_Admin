...
namespace lv_B2C.BLL {
		...
		public partial class WebImage
	{
		...
		private readonly lv_B2C.DAL.WebImage dal=new lv_B2C.DAL.WebImage();
        ...
        {
            return dal.Update(ImageID, fieldName, fieldValue);
        }
		...
		{
			return dal.DeleteList(ImageIDList );
		}

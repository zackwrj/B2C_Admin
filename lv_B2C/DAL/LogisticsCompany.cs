...
namespace lv_B2C.DAL  
{
		...
		public partial class LogisticsCompany
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "LogisticsCompany");
        }
        ...
        public int Update(int ID, object fieldName, object fieldValue)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "LogisticsCompany_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int ID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "LogisticsCompany_Delete", new SqlParameter("@ID", ID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string IDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "LogisticsCompany_DeleteIDList", new SqlParameter("@IDList", IDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.LogisticsCompany GetModel(int ID)
        {
	        try
	        {
	            IList<lv_B2C.Model.LogisticsCompany> iListLogisticsCompany = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.LogisticsCompany>(CommandType.StoredProcedure, "LogisticsCompany_GetModel", new SqlParameter("@ID", ID));
	            if (iListLogisticsCompany.Count > 0)
	            {
	                return iListLogisticsCompany[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "LogisticsCompany_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.LogisticsCompany> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.LogisticsCompany>(CommandType.StoredProcedure, "LogisticsCompany_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.LogisticsCompany> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.LogisticsCompany>(CommandType.StoredProcedure, "LogisticsCompany_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.LogisticsCompany> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.LogisticsCompany>(CommandType.StoredProcedure, "LogisticsCompany_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.LogisticsCompany> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.LogisticsCompany>(CommandType.StoredProcedure, "LogisticsCompany_GetListByPage", parameters);
            }
            catch
            {
                return null;

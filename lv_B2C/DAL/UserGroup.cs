...
namespace lv_B2C.DAL  
{
	...
	{
		#region  Method
        private const string _defaultOrder = "UserGroupID desc ";
		...
		{
			return Merger(model, "UserGroup_ADD");	
		}		
		...
		{
			 return Merger(model, "UserGroup_Update");
		}
		
		/// <summary>
        /// 执行更新或新增的存储过程
        /// </summary>
		private int Merger(lv_B2C.Model.UserGroup model, string strStoredProcedure)
        {
        	try
            {
	            SqlParameter[] parameters = {
	            	            ...
	            	            new SqlParameter("@UserRightList", model.UserRightList) ,            
        ...
        public int Update(int UserGroupID, object fieldName, object fieldValue)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "UserGroup_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int UserGroupID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "UserGroup_Delete", new SqlParameter("@UserGroupID", UserGroupID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string UserGroupIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "UserGroup_DeleteIDList", new SqlParameter("@UserGroupIDList", UserGroupIDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.UserGroup GetModel(int UserGroupID)
        {
	        try
	        {
	            IList<lv_B2C.Model.UserGroup> iListUserGroup = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserGroup>(CommandType.StoredProcedure, "UserGroup_GetModel", new SqlParameter("@UserGroupID", UserGroupID));
	            if (iListUserGroup.Count > 0)
	            {
	                return iListUserGroup[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "UserGroup_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.UserGroup> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserGroup>(CommandType.StoredProcedure, "UserGroup_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.UserGroup> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserGroup>(CommandType.StoredProcedure, "UserGroup_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.UserGroup> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserGroup>(CommandType.StoredProcedure, "UserGroup_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.UserGroup> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserGroup>(CommandType.StoredProcedure, "UserGroup_GetListByPage", parameters);
            }
            catch
            {
                return null;

...
namespace lv_B2C.DAL  
{
	...
	{
		#region  Method
        private const string _defaultOrder = "AccountID desc ";
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("AccountID", "UserAccount");
        }
		...
		{
			return Merger(model, "UserAccount_ADD");	
		}		
		...
		{
			 return Merger(model, "UserAccount_Update");
		}
		
		/// <summary>
        /// 执行更新或新增的存储过程
        /// </summary>
		private int Merger(lv_B2C.Model.UserAccount model, string strStoredProcedure)
        {
        	try
            {
	            SqlParameter[] parameters = {
	            	            ...
	            	            new SqlParameter("@FundsMoney", model.FundsMoney) ,            
	            	            new SqlParameter("@FrozenMoney", model.FrozenMoney) ,            
	            	            new SqlParameter("@LevelIntegral", model.LevelIntegral) ,            
	            	            new SqlParameter("@ConsIntegral", model.ConsIntegral) ,            
        ...
        public int Update(int AccountID, object fieldName, object fieldValue)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "UserAccount_UpdateField", parameters);
            }
            catch
            {
                return -1;
        ...
        public int Delete(int AccountID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "UserAccount_Delete", new SqlParameter("@AccountID", AccountID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string AccountIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "UserAccount_DeleteIDList", new SqlParameter("@AccountIDList", AccountIDList));
            }
            catch
            {
                return -1;
        ...
        public lv_B2C.Model.UserAccount GetModel(int AccountID)
        {
	        try
	        {
	            IList<lv_B2C.Model.UserAccount> iListUserAccount = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserAccount>(CommandType.StoredProcedure, "UserAccount_GetModel", new SqlParameter("@AccountID", AccountID));
	            if (iListUserAccount.Count > 0)
	            {
	                return iListUserAccount[0];
	            }
	            else
	            {
	                return null;
        ...
        public int GetRecordCount(string strWhere)
        {
            try
            {
                ...
                return Convert.ToInt32(lv_DBUtility.DBManager.Instance().ExecuteScalar(CommandType.StoredProcedure, "UserAccount_GetRecordCount", parameters));
            }
            catch
            {
                return -1;
        ...
        public IList<lv_B2C.Model.UserAccount> GetList(int top, string strWhere, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserAccount>(CommandType.StoredProcedure, "UserAccount_GetList", parameters);
            }
            catch
            {
                return null;
        ...
        public IList<lv_B2C.Model.UserAccount> GetListLikeTitle(int top, string strTitle, string fieldOrder)
        {
            try
            {
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserAccount>(CommandType.StoredProcedure, "UserAccount_GetListLikeTitle", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.UserAccount> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserAccount>(CommandType.StoredProcedure, "UserAccount_GetListByIDList", parameters);
            }
            catch
            {
                return null;
        ...
        private IList<lv_B2C.Model.UserAccount> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 
                ...
                return lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.UserAccount>(CommandType.StoredProcedure, "UserAccount_GetListByPage", parameters);
            }
            catch
            {
                return null;

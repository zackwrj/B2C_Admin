...
namespace lv_B2C.DAL  
{
		...
		public partial class ArticleConn
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ArticleID", "ArticleConn");
        }
        ...
        public int Delete(int ArticleID)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "ArticleConn_Delete", new SqlParameter("@ArticleID", ArticleID));
            }
            catch
            {
                return -1;
        ...
        public int DeleteList(string ArticleIDList)
        {
            try
            {
                return lv_DBUtility.DBManager.Instance().ExecuteNonQuery(CommandType.StoredProcedure, "ArticleConn_DeleteIDList", new SqlParameter("@ArticleIDList", ArticleIDList));
            }
            catch
            {
                return -1;
        ...
        /// 得到一个对象实体
        /// </summary>
        public lv_B2C.Model.ArticleConn GetModel(int ArticleID)
        {
	        try
	        {
	            IList<lv_B2C.Model.ArticleConn> iListArticleConn = lv_DBUtility.DBManager.Instance().ExecuteReaderList<lv_B2C.Model.ArticleConn>(CommandType.StoredProcedure, "ArticleConn_GetModel", new SqlParameter("@ArticleID", ArticleID));
        ...
        /// </summary>
        public IList<lv_B2C.Model.ArticleConn> GetListNotIDList(string strIDList)
        {
        ...
        /// 获得数据列表-id not in (1,2,3)
        /// </summary>
        public IList<lv_B2C.Model.ArticleConn> GetListNotIDList(int top, string strIDList, string fieldOrder)
        {
        ...
        private IList<lv_B2C.Model.ArticleConn> IDListMerger(int top, string strIDList, string fieldOrder, int inTypes)
        {
            try
            {
                SqlParameter[] parameters = { 
        ...
        private IList<lv_B2C.Model.ArticleConn> PageMerger(string strWhere, string fieldOrder, int pageIndex, int pageSize, int pageType)
        {
            try
            {
                SqlParameter[] parameters = { 

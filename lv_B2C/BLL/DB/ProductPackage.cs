...
namespace lv_B2C.BLL {
		...
		public partial class ProductPackage
	{
		...
		private readonly lv_B2C.DAL.ProductPackage dal=new lv_B2C.DAL.ProductPackage();
        ...
        {
            return dal.Update(PackageID, fieldName, fieldValue);
        }
		...
		{
			return dal.DeleteList(PackageIDList );
		}

...
namespace lv_B2C.BLL {
		...
		public partial class ExtendType
	{
		...
		private readonly lv_B2C.DAL.ExtendType dal=new lv_B2C.DAL.ExtendType();
        ...
        {
            return dal.Update(ExtendTypeID, fieldName, fieldValue);
        }
		...
		{
			return dal.Delete(ExtendTypeID);
		}
		...
		{
			return dal.DeleteList(ExtendTypeIDList );
		}
		...
		{			
			return dal.GetModel(ExtendTypeID);
		}

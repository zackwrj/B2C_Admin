...
namespace lv_B2C.Web.Adminlvcn.ProductManage.ProductBrand.ajax
{
    public partial class ajax : System.Web.UI.Page
    {
        ...
        public void SearchEmployees()
        {
            try
            {
                ...
                Hashtable result = bllProductBrand.GetHashList(strWhere, sortField + " " + sortOrder, pageIndex, pageSize);
        ...
        public void RemoveEmployees()
        {
            ...
            if (Request["id"] != null)
            {
                ...
                int rs = bllProductBrand.Delete(id);
                if (rs == 1)
                {
        ...
        public void RemoveList()
        {
            if (Request["id"] != null)
            {
                int rs = bllProductBrand.DeleteList(Request["id"]);
                if (rs == 1)
                {
                    Response.Write(rs.ToString());
                }
        ...
        public void SaveEmployees()
        {
            ...
            Model.ProductBrand modelProduct = bllProductBrand.GetModel(Convert.ToInt32(hasTab["ProductID"]));
            ...
            bllProductBrand.Update(modelProduct);
        }
    }
}